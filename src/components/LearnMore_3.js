...
const LearnMore_3 = () => {
    const { 
        ...
        logoStyle } = styles;
    return (
       <ImageBackground source={require('./img/communityImg.png')}> 
            <Image source={require('./img/ANOKOLogo.png')} style={logoStyle}/>               
            <Text style={textHeaderStyle}>COMMUNITY</Text>
            <TouchableOpacity onPress={() => Actions.LearnMore4({})} style={navButtonRightStyle}>
                <Image source={require('./img/rightChevron.png')} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => Actions.LearnMore2({})} style={navButtonLeftStyle}>
